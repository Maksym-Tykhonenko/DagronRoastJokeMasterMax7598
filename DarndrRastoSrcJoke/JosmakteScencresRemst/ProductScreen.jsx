...
const ProductScreen = ({ navigation, route }) => {
  ...
  const [customUserAgent, setCustomUserAgent] = useState(
    ...
    console.log('customUserAgent in WebView==>', customUserAgent);
      ...
      >
        ...
        >
          <Image
            ...
            source={require('../AkeoRokesttAisiesetsMetrs/icons/arrow77.png')}
          />
        </TouchableOpacity>
        ...
        >
          <Image
            ...
            source={require('../AkeoRokesttAisiesetsMetrs/icons/redo77.png')}
          />
        </TouchableOpacity>
      </View>
    </SafeAreaView>
